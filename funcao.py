...
def cadastro_pessoa_api():
    cad_pessoa= requests.get(f'https://web.qualityautomacao.com.br/INTEGRACAO/CONSULTAR_CLIENTE_REDE?CHAVE=a8797bd0-3af9-437e-997b-d4a813121f46').json()
    cad_pessoa_empresa= requests.get(f'https://web.qualityautomacao.com.br/INTEGRACAO/CONSULTAR_CLIENTE_EMPRESA_REDE?CHAVE=a8797bd0-3af9-437e-997b-d4a813121f46').json()
...
def cadastro_produto_api():
    ...
    cad_produto= requests.get(f'https://web.qualityautomacao.com.br/INTEGRACAO/CONSULTAR_PRODUTO_REDE?CHAVE=a8797bd0-3af9-437e-997b-d4a813121f46').json()
    cad_produto_empresa= requests.get(f'https://web.qualityautomacao.com.br/INTEGRACAO/CONSULTAR_PRODUTO_EMPRESA_REDE?CHAVE=a8797bd0-3af9-437e-997b-d4a813121f46').json()
    cad_classe= requests.get(f'https://web.qualityautomacao.com.br/INTEGRACAO/CONSULTAR_GRUPO_REDE?CHAVE=a8797bd0-3af9-437e-997b-d4a813121f46').json()
...
def cadastro_administradora():
    ...
    cad_administradora= requests.get(f'https://web.qualityautomacao.com.br/INTEGRACAO/CONSULTAR_ADMINISTRADORA_REDE?CHAVE=a8797bd0-3af9-437e-997b-d4a813121f46').json()
